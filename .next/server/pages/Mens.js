...
module.exports = __webpack_require__("eyH2");
...
// CONCATENATED MODULE: ./src/Components/MensBanner.js
...
const MensBanner = () => {
  ...
  return __jsx(Card_default.a, {
    ...
    variant: "h3"
  }, "MEN'S") : __jsx(Typography_default.a, {
    className: classes.overlay,
    variant: "h2",
...
/* harmony default export */ var Components_MensBanner = (MensBanner);
...
// CONCATENATED MODULE: ./src/Components/MensClothesItem.js
var MensClothesItem_jsx = external_react_default.a.createElement;
...
const MensClothesItem_useStyles = Object(styles_["makeStyles"])({
  root: {
    width: '110',
    borderRadius: 0,
    margin: '5px 5px'
...
const MensClothesItem = ({
  element,
  addToCart,
  getViewProduct
}) => {
  const classes = MensClothesItem_useStyles(); // creat logic for tags

  return MensClothesItem_jsx(Card_default.a, {
    className: classes.root
  }, MensClothesItem_jsx(external_react_router_dom_["NavLink"], {
    to: "/product",
    className: classes.link,
    onClick: () => {
      getViewProduct(element);
    }
  }, MensClothesItem_jsx(CardActionArea_default.a, null, MensClothesItem_jsx(CardMedia_default.a, {
    className: classes.media,
    image: element.img,
    title: "Contemplative Reptile"
  }), MensClothesItem_jsx(CardContent_default.a, null, MensClothesItem_jsx(Typography_default.a, {
    gutterBottom: true,
    variant: "h5",
    component: "h2"
  }, element.name), MensClothesItem_jsx(Typography_default.a, {
    variant: "h6",
    color: "textPrimary",
    component: "p"
  }, "\xA3", element.price), MensClothesItem_jsx(Typography_default.a, {
    variant: "body2",
    color: "textPrimary",
    component: "p"
  }, "Tags: ", element.tags)))), MensClothesItem_jsx(CardActions_default.a, null, MensClothesItem_jsx(Button_default.a, {
    size: "small",
    color: "primary",
    onClick: () => {
      addToCart(element);
    ...
    variant: "contained"
  }, MensClothesItem_jsx(ShoppingCart_default.a, null))));
};

/* harmony default export */ var Components_MensClothesItem = (MensClothesItem);
// CONCATENATED MODULE: ./src/pages/Mens.js
var Mens_jsx = external_react_default.a.createElement;
...
const Mens = ({
  ...
  return Mens_jsx("div", null, Mens_jsx(Grid_default.a, {
    container: true,
    direction: "column"
  }, Mens_jsx(Grid_default.a, {
    item: true
  }, Mens_jsx(Components_MensBanner, null)), Mens_jsx(Grid_default.a, {
    item: true
  }, Mens_jsx(SortBy["a" /* default */], null)), Mens_jsx(Grid_default.a, {
    container: true
  }, productsMens.map((item, i) => Mens_jsx(Grid_default.a, {
    item: true,
    md: 4,
    sm: 6,
    xs: 12,
    key: i
  }, Mens_jsx(Components_MensClothesItem, {
    element: item[1],
    addToCart: addToCart,
...
/* harmony default export */ var pages_Mens = __webpack_exports__["default"] = (Mens);
